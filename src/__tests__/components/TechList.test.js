...
describe('TechList component', () => {
  ...
  it('should store techs in storage', () => {
    ...
    // Garantir que o localStorage.setItem foi chamado
    // Foi feito um mock do localStorage, pois não precisamos garantir o funcionamento dele, mas sim que nossa aplicação o esta chamando
